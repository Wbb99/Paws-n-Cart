    ...
    try:
        ...
        if choice == "1":
            ...
            try:
                ...
                print("{} has been added to your cart.".format(item, quantity))
        ...
        # If the user chooses to remove an item from the cart
            ...
            for item, price, quantity in cart_contents:
                if item == remove:
                    ...
                    print("{} has been removed from your cart.".format(remove))
                    break
        ...
        # If the user chooses to exit the program
            ...
            print("Thank you for shopping with Paws n Cart. Exiting...")
            break
